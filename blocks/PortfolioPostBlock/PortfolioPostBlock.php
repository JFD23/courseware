...
namespace Mooc\UI\PortfolioPostBlock;

use Mooc\UI\Block;
use Mooc\DB\Post as Post;
use Courseware\User as User;

class PortfolioPostBlock extends Block
{
    const NAME = 'Kommunikation';
    ...
    {
        return 'http://moocip.de/schema/block/portfoliopost/';
    }
    ...
    {
        return 'http://moocip.de/schema/block/portfoliopost/portfoliopost-1.0.xsd';
    }
